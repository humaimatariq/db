 ...
 * @author Umaima Tariq
 */
public class Cleaning3 extends javax.swing.JFrame
{

    /**
     * Creates new form Cleaning3
     */
    public Cleaning3()
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        cleaning3 = new javax.swing.JLabel();
        ...
        cleaning3.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        cleaning3.setForeground(new java.awt.Color(0, 204, 204));
        cleaning3.setText("Cleaning");

        label2.setFont(new java.awt.Font("Dialog", 1, 16)); // NOI18N
        label2.setForeground(new java.awt.Color(0, 153, 153));
        label2.setText("Dusting, sweeping,vacuuming,mopping,");

        label1.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        label1.setForeground(new java.awt.Color(0, 153, 153));
        label1.setText("cleaning ceiling vents, restroom cleaning etc");

        price.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        price.setForeground(new java.awt.Color(0, 153, 153));
        price.setText("Price");

        cprice.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        cprice.setForeground(new java.awt.Color(0, 153, 153));
        cprice.setText("Rs:4000");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(label2, javax.swing.GroupLayout.PREFERRED_SIZE, 351, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addGap(0, 139, Short.MAX_VALUE)
                                .addComponent(cleaning3)
                                .addGap(135, 135, 135)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cleaning3, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
...
new Payment().setVisible(true);         // TODO add your handling code here:
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(Cleaning3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new Cleaning3().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel cleaning3;
